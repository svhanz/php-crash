...
$c = array_combine($a, $b); // приведет к объединению массивов, причем $a будет ключом, а $b будет значением
print_r($c) . "\n";
// мы можем перевести в обычный массив с индексом и значением
$keys = array_keys($c);
print_r($keys) . "\n";
// мы можем поменять ключи на значения, а значения на ключи
